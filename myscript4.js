...
function sensorReading2(){
	...
	console.log("Swithch Sensor Value"+" "+ switch_presence);
	...
	console.log("IR sensor Value"+" "+ vehicle_presence);
	if(vehicle_presence>threshold)
	{
		pin5.write(0);
		pin8.write(1);
		state = 'Gate Close';
